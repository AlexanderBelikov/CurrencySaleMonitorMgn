...
//        Log.i(TAG, "parseBankCourse: Name:" + bankName);
//        Log.i(TAG, "parseBankCourse: Date:" + courseDate);
//        Log.i(TAG, "parseBankCourse: USD:" + courseUsdSell);
//        Log.i(TAG, "parseBankCourse: EUR:" + courseEurSell);
